...
# Generate Go files
$PROTOC_PATH --proto_path=$PROTO_FILE_DIR --go_out=$OUTPUT_DIR_GO --go_opt paths=source_relative --go-grpc_out=$OUTPUT_DIR_GO --go-grpc_opt paths=source_relative *.proto